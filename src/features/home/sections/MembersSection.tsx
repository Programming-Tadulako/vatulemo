...
const MemberCard = ({ name, role, company, avatarUrl }: Member) => {
  ...
  return (
    <figure className="border-border shadow-input relative flex h-full w-md cursor-pointer items-center gap-3 overflow-hidden rounded-xl border p-8 hover:shadow-md">
      <Image
        width={56}
        height={56}
